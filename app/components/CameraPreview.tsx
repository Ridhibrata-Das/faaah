...
import { getAudioLevel, pcmToWav } from '@/app/utils/audio';
...
export default function CameraPreview({
  ...
  return (
    <div className={cn("flex flex-col h-full w-full", className)}>
      <div className="relative flex-1 rounded-xl overflow-hidden shadow-2xl bg-gradient-to-b from-gray-900 to-gray-800 p-1">
        <video
          ref={videoRef}
          autoPlay
          playsInline
          className="w-full h-full rounded-lg overflow-hidden object-cover bg-black/20"
      ...
      {isStreaming && (
        <div className="w-full h-1.5 rounded-full bg-gray-200/10 overflow-hidden mt-1">
          <div
            className="h-full rounded-full transition-all bg-gradient-to-r from-emerald-400 to-emerald-500"
            style={{
